...
/**
 * Created by Renado_Paria on 4/10/2017 at 12:10 AM for DcitApp.
 */

public class COMPCardFragment extends Fragment implements ValueEventListener
{
    private static final String TAG = "COMPCardFragment";
    private CoursesRVAdapter courseAdapter;

    public COMPCardFragment()
    {
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        Query query = databaseReference.orderByChild("degree").equalTo("COMP");
    ...
    public void onDataChange(DataSnapshot dataSnapshot)
    {
        ...
        Log.d(TAG, "onDataChange: courses = " + courses.toString());
    }
